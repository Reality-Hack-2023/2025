...
public class DummyComponentEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        editorTextFieldNoLabel.stringValue = AutoCompleteTextField.EditorGUILayout.AutoCompleteTextField(editorTextFieldNoLabel.stringValue, options, "Type something here too", false, true, GUILayout.Width(200));
        ...
        AutoCompleteDropDown.EditorGUILayout.AutoCompleteDropDown(editorDropDownNoLabel.stringValue, options, s =>
        {
            ...
            serializedObject.ApplyModifiedProperties();
        }, false, true, GUILayout.Width(200));
